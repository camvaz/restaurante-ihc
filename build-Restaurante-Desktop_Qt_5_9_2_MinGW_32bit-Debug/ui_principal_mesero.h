...
public:
    ...
    void setupUi(QMainWindow *Principal_Mesero)
    {
        ...
        Principal_Mesero->setStyleSheet(QStringLiteral("/*background-color: rgb(12, 12, 12);*/"));
...
"border-radius: 20px  20px;;"));
        ...
        frame->setGeometry(QRect(0, 80, 751, 440));
...
" "));
        ...
        line_3->setGeometry(QRect(120, 30, 640, 16));
...
"color: rgb(201, 37, 49);"));
        ...
        line_5->setGeometry(QRect(150, 30, 610, 16));
        ...
        line_6->setGeometry(QRect(130, 30, 630, 16));
        ...
        line_7->setGeometry(QRect(210, 30, 550, 16));
        ...
        label_10->setStyleSheet(QStringLiteral("color: rgb(201, 37, 49);font: 16pt \"MS Shell Dlg 2\";"));
        ...
        coctel->setGeometry(QRect(140, 190, 121, 111));
        ...
        vino->setGeometry(QRect(420, 190, 121, 111));
        ...
        label_271->setGeometry(QRect(160, 310, 70, 20));
        label_271->setStyleSheet(QStringLiteral("font: 10pt \"MS Shell Dlg 2\";"));
        label_272 = new QLabel(page_11);
        label_272->setObjectName(QStringLiteral("label_272"));
        label_272->setGeometry(QRect(460, 310, 40, 20));
        label_272->setStyleSheet(QStringLiteral("font: 10pt \"MS Shell Dlg 2\";"));
        ...
        scrollAreaWidgetContents_10->setGeometry(QRect(0, 0, 748, 418));
        ...
        line->setGeometry(QRect(110, 10, 16, 540));
    ...
    void retranslateUi(QMainWindow *Principal_Mesero)
    {
        ...
        cuenta->setText(QApplication::translate("Principal_Mesero", "cuentas", Q_NULLPTR));
